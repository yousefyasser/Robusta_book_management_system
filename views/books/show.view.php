...
<main class="flex-grow">
    ...
    <section class="py-20">
        <div class="container mx-auto">
            <div class="bg-white p-8 rounded-lg shadow-lg m-10">
                <div class="flex flex-col md:flex-row md:space-x-8">
                    <img src="<?= valid_path($book['cover_image']) ? $book['cover_image'] : "https://via.placeholder.com/50x75" ?>" alt="Book Cover" class="w-[300px] h-96 object-cover rounded-md mb-6 md:mb-0">
                    <div>
